...
Source3: nvidia-dra-driver-gpu-disabled-marker
...
install -D -m 0644 %{S:3} %{buildroot}%{_cross_templatedir}/nvidia-dra-driver-gpu-disabled-marker
...
%{_cross_templatedir}/nvidia-dra-driver-gpu-disabled-marker
